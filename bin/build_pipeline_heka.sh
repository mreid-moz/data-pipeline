...
if [ ! -f "patches_applied" ]; then
    ...
    echo "add_external_plugin(git https://github.com/mozilla-services/data-pipeline/lz :local)" >> cmake/plugin_loader.cmake
    ...
    echo "add_external_plugin(hg https://code.google.com/p/lzma default)" >> cmake/plugin_loader.cmake
fi
